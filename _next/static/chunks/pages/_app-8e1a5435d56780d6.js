  ...
  [888, 432],
  {
    ...
    4793: function (e, t, n) {
      ...
      var b = c.default.forwardRef(function (e, t) {
        ...
        var F = M ? k && "object" === typeof k && k.ref : t,
        ...
        if (!M || g || ("a" === k.type && !("href" in k.props))) {
          var Y = "undefined" !== typeof O ? O : S && S.locale,
            G =
              S &&
              S.isLocaleDomain &&
              p.getDomainLocale(R, Y, S.locales, S.domainLocales);
          W.href = G || d.addBasePath(a.addLocale(R, Y, S && S.defaultLocale));
        }
        return M
          ? c.default.cloneElement(k, W)
          : c.default.createElement("a", Object.assign({}, P, W), n);
      });
      (t.default = b),
        ("function" === typeof t.default ||
          ("object" === typeof t.default && null !== t.default)) &&
