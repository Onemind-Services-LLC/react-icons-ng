(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [888, 432],
  {
    ...
    4793: function (e, t, n) {
      ...
      var b = c.default.forwardRef(function (e, t) {
        var n,
          o = e.href,
          b = e.as,
          v = e.children,
        ...
        var _ = !1 !== y,
          S = c.default.useContext(l.RouterContext),
          L = c.default.useContext(u.AppRouterContext);
        L && (S = L);
        var k,
          T = c.default.useMemo(
            function () {
              var e = s.resolveHref(S, o, !0),
                ...
                n = t[0],
                i = t[1];
              return { href: n, as: b ? s.resolveHref(S, b) : i || n };
            },
            [S, o, b]
          ),
          N = T.href,
          R = T.as,
          A = c.default.useRef(N),
          B = c.default.useRef(R);
        M && (k = c.default.Children.only(n));
        var D = M ? k && "object" === typeof k && k.ref : t,
          F = f.useIntersection({ rootMargin: "200px" }),
          z = r(F, 3),
          Z = z[0],
          H = z[1],
          Q = z[2],
          q = c.default.useCallback(
            function (e) {
              (B.current === R && A.current === N) ||
                (Q(), (B.current = R), (A.current = N)),
                Z(e),
                D &&
                  ("function" === typeof D
                    ? D(e)
        ...
        c.default.useEffect(
          function () {
            var e = H && _ && s.isLocalURL(N),
              t = "undefined" !== typeof O ? O : S && S.locale,
              n = h[N + "%" + R + (t ? "%" + t : "")];
            e && !n && m(S, N, R, { locale: t });
          },
          [R, N, H, O, _, S]
        );
        var V = {
          ...
          onMouseEnter: function (e) {
            M || "function" !== typeof I || I(e),
              ...
              (!_ && L) || (s.isLocalURL(N) && m(S, N, R, { priority: !0 }));
          },
        ...
        if (!M || g || ("a" === k.type && !("href" in k.props))) {
          var W = "undefined" !== typeof O ? O : S && S.locale,
            Y =
              S &&
              S.isLocaleDomain &&
              p.getDomainLocale(R, W, S.locales, S.domainLocales);
          V.href = Y || d.addBasePath(a.addLocale(R, W, S && S.defaultLocale));
        }
        return M
          ? c.default.cloneElement(k, V)
          : c.default.createElement("a", Object.assign({}, P, V), n);
      });
      (t.default = b),
        ("function" === typeof t.default ||
          ("object" === typeof t.default && null !== t.default)) &&
    ...
    8715: function (e, t, n) {
      ...
      var C = function (e) {
          var t = e.children,
            ...
            a = s.props.className || "";
          return (
            c.asPath === n && o && (a = "".concat(a, " ").concat(o).trim()),
            (0, f.jsx)(
              y(),
              x(
                x({ href: n }, i),
            ...
            (0, f.jsx)("div", {
              ...
              children: (0, f.jsx)("input", {
                ...
                onChange: function (e) {
                  ...
                  t.push({ pathname: E, query: n ? { q: n } : null }),
                    v(n),
                    b(function (e) {
                      return {};
                    });
                  ...
                  return (0, f.jsx)(h.z, {
                    children: (0, f.jsxs)(f.Fragment, {
                      children: [
                        (0, f.jsx)(U, {}),
                        (0, f.jsx)(_(), {
                          children: (0, f.jsx)("title", { children: O.tH }),
                        }),
    ...
    795: function (e, t, n) {
      ...
      var r = [
        ...
        c = o.createContext && o.createContext(i),
        s = function () {
          return (
            (s =
              Object.assign ||
        ...
        var t = function (t) {
          ...
          return (
            ...
            o.createElement(
              ...
              c && o.createElement("title", null, c),
              e.children
            )
          );
        };
        return void 0 !== c
          ? o.createElement(c.Consumer, null, function (e) {
              return t(e);
            })
          : t(i);
      }
