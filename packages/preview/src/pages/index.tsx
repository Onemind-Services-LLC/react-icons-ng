...
export default function HomePage() {
    return (
        <Container title={BRAND_TITLE}>
            ...
            <h2>More info</h2>
            <p>
                Before proceeding, please note that the NPM registry for this package is hosted on GitHub. You need to
                configure your NPM client to use GitHub Packages registry for this package. For more information, see <a
                ...
                target="_blank" rel="noopener noreferrer">Configuring npm for use with GitHub Packages</a>.
            </p>
